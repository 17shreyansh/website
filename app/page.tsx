          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-5 leading-[1.1]">
                ...
                <span className="block text-gold-400 mt-2">One Project at a Time</span>
              </h1>
              
              <p className="text-lg text-gray-300 mb-8 max-w-xl leading-relaxed">
                Premium construction materials from India's most trusted brands. Quality you can build on, service you can rely on.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For over 25 years, RSD Bharti Industries has been the cornerstone of quality construction materials in India. We partner directly with top manufacturers to bring you genuine products at competitive prices.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                From small contractors to large developers, we've supplied materials for over 1,000 projects across the region. Our commitment to quality and timely delivery has made us the trusted choice for construction professionals.
              </p>
              <Link href="/about">
            ...
            >
              <div className="bg-gradient-to-br from-primary-700 to-primary-900 text-white p-8 rounded-2xl">
                ...
                <p className="text-primary-100">A quarter-century of excellence in delivering premium construction materials.</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600">Direct from manufacturers</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 mb-5">Top-grade cement from India's leading manufacturers for superior strength.</p>
              <div className="space-y-2 mb-6">
                {['UltraTech', 'Dalmia', 'ACC', 'Ambuja'].map((brand) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">TMT Steel</h3>
              <p className="text-gray-600 mb-5">High-strength TMT bars from trusted brands for robust structures.</p>
              <div className="space-y-2 mb-6">
                {['Tata Tiscon', 'JSW', 'Jindal', 'Kamdhenu'].map((brand) => (
                  <div key={brand} className="flex items-center text-sm text-gray-700">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Essentials</h3>
              <p className="text-gray-600 mb-5">Complete range of construction materials for every project stage.</p>
              <div className="space-y-2 mb-6">
                {['Sand', 'Stone Chips', 'Binding Wire', 'Aggregates'].map((item) => (
